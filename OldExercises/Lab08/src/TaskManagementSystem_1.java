...
public class TaskManagementSystem_1 {
    ...
    public static class Task {
        ...
        public String toString() {
            ...
            return "Zadanie: "+name+", Deadline: "+deadline.format(formatter)+", Priorytet: "+priority+", Status: "+status;
        }
    ...
    public static class TaskManager {
        ...
        public List<Task> filterByPriority(Priority priority){
            return tasks.stream().filter(a -> a.priority == priority).toList();
        }

        public void generateRandomTasks(int ile, LocalDate startDate, int naIleDni){
            for (int i = 0; i < ile; i++) {
    ...
    public static void main(String[] args) {
        ...
        manager.filterByPriority(Priority.HIGH).forEach(System.out::println);
